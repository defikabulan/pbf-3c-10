            ...
            <div className="col-12 tm-media tm-media-v-center">
              ...
              <div>
                <p>
                  ...
                  at, condimentum et dui. Proin mi enim, dapibus at metus
                  semper, hendrerit faucibus nisi.
                </p>
              </div>
            </div>
            <div className="col-12 tm-media tm-media-v-center">
          ...
          <div className="col-md-6">
            <div className="tm-about-1">
              ...
              <p className="tm-article-text">
                ...
                convallis, risus orci auctor orci.
              </p>
              <p>
                Cras imperdiet in ligula sit amet fringilla. Morbi posuere
                mattis ornare. Nunc iaculis porta ipsum. Aliquam vehicula
                egestas diam auctor ornare.
              </p>
            </div>
          </div>
          <div className="col-md-6">
